...
<section style="background:var(--sand);padding:80px;">
  <div style="max-width:1000px;margin:0 auto;">
    ...
    <div style="display:grid;grid-template-columns:repeat(2, 1fr);gap:28px;" class="about-story-cards">
      ...
      ?>
          <div style="background:var(--white);padding:28px;border-radius:8px;border:1px solid rgba(44,26,14,0.08);cursor:pointer;" class="product-card" data-permalink="<?php the_permalink(); ?>" onclick="window.location.href='<?php the_permalink(); ?>';">
