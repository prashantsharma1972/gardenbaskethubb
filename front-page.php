...
<section class="page-hero"
  ...
  <div style="display:flex;gap:16px;justify-content:center;flex-wrap:wrap;">
    <a href="<?php echo esc_url(gbh_get_page_url('shop')); ?>" class="btn-primary" style="padding:16px 36px;font-size:1rem;">
      Explore Shop ➔
    </a>
    ...
    <?php else: ?>
      ...
      <div class="product-card">
        ...
        <div class="product-body">
          ...
          <div class="product-name"><a href="<?php echo esc_url(gbh_get_page_url('shop')); ?>">Tomato Seedling Tray</a></div>
      ...
      <div class="product-card">
        ...
        <div class="product-body">
          ...
          <div class="product-name"><a href="<?php echo esc_url(gbh_get_page_url('shop')); ?>">Monsoon Veg Seed Kit</a></div>
      ...
      <div class="product-card">
        ...
        <div class="product-body">
          ...
          <div class="product-name"><a href="<?php echo esc_url(gbh_get_page_url('shop')); ?>">Organic Vermicompost 5kg</a>
          </div>
...
<section style="background:var(--sand);padding:80px;">
  ...
  <div style="display:grid;grid-template-columns:repeat(4, 1fr);gap:24px;" class="about-values-grid">
    <div style="background:var(--white);padding:32px 24px;border-radius:8px;border:1px solid rgba(44,26,14,0.08);box-shadow:0 4px 16px rgba(0,0,0,0.02);">
      ...
      <h3 style="font-family:var(--f-display);font-size:1.2rem;color:var(--soil);margin-bottom:10px;">Same-Day Delivery</h3>
      <p style="font-size:0.9rem;color:#7a6050;line-height:1.6;">Fresh saplings delivered within hours across Jaipur in protective sleeves.</p>
    </div>

    <div style="background:var(--white);padding:32px 24px;border-radius:8px;border:1px solid rgba(44,26,14,0.08);box-shadow:0 4px 16px rgba(0,0,0,0.02);">
      <div style="font-size:2.8rem;margin-bottom:16px;">🌿</div>
      <h3 style="font-family:var(--f-display);font-size:1.2rem;color:var(--soil);margin-bottom:10px;">100% Organic Soil</h3>
      <p style="font-size:0.9rem;color:#7a6050;line-height:1.6;">Enriched with local Jaipur vermicompost and neem — zero chemical pesticides.</p>
    </div>

    <div style="background:var(--white);padding:32px 24px;border-radius:8px;border:1px solid rgba(44,26,14,0.08);box-shadow:0 4px 16px rgba(0,0,0,0.02);">
      <div style="font-size:2.8rem;margin-bottom:16px;">💬</div>
      <h3 style="font-family:var(--f-display);font-size:1.2rem;color:var(--soil);margin-bottom:10px;">WhatsApp Doctor</h3>
      <p style="font-size:0.9rem;color:#7a6050;line-height:1.6;">Free plant care advice from our nursery gardeners whenever you need help.</p>
    </div>

    <div style="background:var(--white);padding:32px 24px;border-radius:8px;border:1px solid rgba(44,26,14,0.08);box-shadow:0 4px 16px rgba(0,0,0,0.02);">
      <div style="font-size:2.8rem;margin-bottom:16px;">🏺</div>
      <h3 style="font-family:var(--f-display);font-size:1.2rem;color:var(--soil);margin-bottom:10px;">Handcrafted Pots</h3>
      <p style="font-size:0.9rem;color:#7a6050;line-height:1.6;">Authentic terracotta clay pots crafted by traditional Rajasthan potters.</p>
    </div>
  </div>
</section>
...
<section style="padding:80px;">
  ...
  <div style="display:grid;grid-template-columns:repeat(3, 1fr);gap:28px;" class="about-story-cards">
    <div style="background:#EBF5E9;padding:36px 28px;border-radius:10px;border:1px solid rgba(58,107,53,0.15);">
      <span style="font-family:var(--f-mono);font-size:0.7rem;letter-spacing:0.12em;text-transform:uppercase;color:var(--leaf);display:block;margin-bottom:10px;">July – September</span>
      <h3 style="font-family:var(--f-display);font-size:1.4rem;color:var(--soil);margin-bottom:12px;">🌧️ Monsoon Sowing</h3>
      <p style="font-size:0.92rem;color:#4a5d48;line-height:1.6;margin-bottom:16px;">
        High humidity makes monsoon ideal for germinating heavy yield veggies: Tomatoes, Okra, Ridge Gourd, Bitter Gourd & Marigold saplings.
      </p>
      <a href="<?php echo esc_url(gbh_get_page_url('shop')); ?>" style="font-family:var(--f-body);font-size:0.85rem;font-weight:500;color:var(--leaf);text-decoration:none;">Browse Monsoon Seeds ➔</a>
    </div>

    <div style="background:#FDF7ED;padding:36px 28px;border-radius:10px;border:1px solid rgba(232,148,42,0.2);">
      <span style="font-family:var(--f-mono);font-size:0.7rem;letter-spacing:0.12em;text-transform:uppercase;color:var(--marigold);display:block;margin-bottom:10px;">October – February</span>
      <h3 style="font-family:var(--f-display);font-size:1.4rem;color:var(--soil);margin-bottom:12px;">❄️ Winter Veggies</h3>
      <p style="font-size:0.92rem;color:#6b5239;line-height:1.6;margin-bottom:16px;">
        Cool Jaipur winters produce crisp leafy greens: Spinach, Carrots, Radish, Methi, Lettuce, Broccoli & colorful Petunias.
      </p>
      <a href="<?php echo esc_url(gbh_get_page_url('shop')); ?>" style="font-family:var(--f-body);font-size:0.85rem;font-weight:500;color:var(--marigold);text-decoration:none;">Browse Winter Seeds ➔</a>
    </div>

    <div style="background:var(--sand);padding:36px 28px;border-radius:10px;border:1px solid rgba(44,26,14,0.1);">
      <span style="font-family:var(--f-mono);font-size:0.7rem;letter-spacing:0.12em;text-transform:uppercase;color:var(--clay);display:block;margin-bottom:10px;">March – June</span>
      <h3 style="font-family:var(--f-display);font-size:1.4rem;color:var(--soil);margin-bottom:12px;">☀️ Summer Harvest</h3>
      <p style="font-size:0.92rem;color:#5c4436;line-height:1.6;margin-bottom:16px;">
        Heat-tolerant summer crops that love full sun: Mint, Cucumber, Watermelon, Zucchini, Gourds & shade-loving house plants.
      </p>
      <a href="<?php echo esc_url(gbh_get_page_url('shop')); ?>" style="font-family:var(--f-body);font-size:0.85rem;font-weight:500;color:var(--clay);text-decoration:none;">Browse Summer Supplies ➔</a>
    </div>
  </div>
</section>
  ...
  <div style="display:grid;grid-template-columns:repeat(3, 1fr);gap:28px;" class="about-story-cards">
    ...
    if ($featured_blogs->have_posts()):
      while ($featured_blogs->have_posts()): $featured_blogs->the_post();
        ...
        if (!$fb_read_time && function_exists('get_field')) $fb_read_time = get_field('read_time', $fb_id);
        if (!$fb_read_time) $fb_read_time = '5 min read';
        $fb_thumb = get_the_post_thumbnail_url($fb_id, 'medium');
    ?>
        <div style="background:var(--white);padding:28px;border-radius:10px;border:1px solid rgba(44,26,14,0.08);box-shadow:0 4px 16px rgba(0,0,0,0.02);cursor:pointer;display:flex;flex-direction:column;justify-content:space-between;" class="product-card" data-permalink="<?php the_permalink(); ?>">
          <div>
            <div style="font-family:var(--f-mono);font-size:0.7rem;color:var(--clay);letter-spacing:0.08em;text-transform:uppercase;margin-bottom:10px;display:flex;justify-content:space-between;">
              <span><?php echo get_the_date('M j, Y'); ?></span>
              <span>⏱️ <?php echo esc_html($fb_read_time); ?></span>
            </div>
            <h3 style="font-family:var(--f-display);font-size:1.25rem;color:var(--soil);margin-bottom:12px;line-height:1.3;">
          ...
          <div>
            <a href="<?php the_permalink(); ?>" class="btn-ghost" style="font-size:0.85rem;color:var(--leaf);font-weight:500;">
              Read Guide ➔
            </a>
          </div>
        </div>
