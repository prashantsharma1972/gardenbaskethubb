...
<head>
    ...
    <link rel="preload" as="style" href="<?php echo GBH_THEME_URI; ?>/build/blogs/blogs.css">
    <link rel="stylesheet" href="<?php echo GBH_THEME_URI; ?>/build/blogs/blogs.css">
    <script type="module" defer fetchpriority="low" src="<?php echo GBH_THEME_URI; ?>/build/blogs/blogs.bundle.js"></script>
