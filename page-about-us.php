...
<section>
  <div class="about-grid">
    ...
    <div class="about-text">
      ...
      <p>We noticed something simple: people wanted to grow their own food but didn't know where to start. So we built a
        shop that helps gardeners at every level — from the curious beginner with a balcony, to the experienced grower
        with a full terrace garden.</p>
    </div>
  </div>
