...
<footer class="footer">
  ...
  <div class="footer-main footer-top">
    <div class="footer-tagline footer-brand">
    ...
    <div class="footer-services footer-col">
      <span class="footer--heading">Shop Essentials</span>
      <ul class="service-list">
        <li><a href="/shop/">Organic Seeds</a></li>
        <li><a href="/shop/">Fresh Seedlings (Jaipur)</a></li>
        <li><a href="/shop/">Vermicompost & Soil</a></li>
        <li><a href="/shop/">Gardening Tools</a></li>
        <li><a href="/shop/">Pots & Planters</a></li>
      </ul>
    </div>

    <div class="footer-services footer-col">
      <span class="footer--heading">Information & Legal</span>
      <ul class="service-list">
        <li><a href="/about-us/">About Us & Nursery</a></li>
        <li><a href="/blog/">Gardening Blog & Guides</a></li>
        <li><a href="/reels/">Gardening Video Guides</a></li>
        <li><a href="/privacy-policy/">Privacy Policy</a></li>
        <li><a href="/terms-and-conditions/">Terms & Conditions</a></li>
        <li><a href="/refund-policy/">Refund & Shipping Policy</a></li>
      </ul>
    </div>
  ...
  <div class="legal footer-bottom">
    <div class="rights-text">
      ...
      <div class="terms-privacy footer-socials">
        <!-- Instagram SVG -->
