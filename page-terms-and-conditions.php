...
<head>
  ...
  <link rel="preload" as="style"
    href="/wp-content/themes/gardenbaskethubb/build/termsAndConditions/termsAndConditions.css">
  <link rel="stylesheet" href="/wp-content/themes/gardenbaskethubb/build/termsAndConditions/termsAndConditions.css">
  <script type="module" defer fetchpriority="low"
    src="/wp-content/themes/gardenbaskethubb/build/termsAndConditions/termsAndConditions.bundle.js"></script>
  <?php get_header(); ?>
  <main class="main--container">
    ...
    <section class="page-hero doc-hero">
      ...
      <p class="hero-desc">
        The rules of our garden. Please read before placing an order.eds, seedlings, and supplies from Garden Basket
        Hub.
      </p>
    </section>
    ...
    <section>
      <div class="doc-content">
        <h2 class="doc-heading">1. General Store Terms</h2>
        <p class="doc-text">
        ...
        <h2 class="doc-heading">2. Fresh Seedling & Jaipur Local Delivery</h2>
        <p class="doc-text">
