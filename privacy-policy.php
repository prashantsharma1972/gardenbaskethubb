...
<head>
    ...
    <link rel="preload" as="style" href="<?php echo GBH_THEME_URI; ?>/build/privacyPolicy/privacyPolicy.css">
    <link rel="stylesheet" href="<?php echo GBH_THEME_URI; ?>/build/privacyPolicy/privacyPolicy.css">
    <script type="module" defer fetchpriority="low" src="<?php echo GBH_THEME_URI; ?>/build/privacyPolicy/privacyPolicy.bundle.js"></script>
    ...
    <main class="main--container">
        ...
        <section class="about-privacy-policy">
            <p>
                At gardenbaskethubb, we are committed to ensuring your personal information is protected at all times, and
                this privacy policy outlines what data gardenbaskethubb collects, uses, and processes about you. It also
                explains your data rights and how you can contact us if you have any queries. We hold the right to alter
                this privacy policy statement at our discretion and encourage you to check this page from time to time
        ...
        <section class="what-are-your-rights">
            ...
            <p>
                You can contact gettrained@gardenbaskethubb.com to request your personal information, or in case you
                have any
