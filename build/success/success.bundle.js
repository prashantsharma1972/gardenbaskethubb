...
/*!****************************!*\
  ...
  \****************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _success_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./success.scss */ "./success/success.scss");
...
if (url.searchParams.get('emailid')) {
  document.querySelector('.emailid').innerHTML = url.searchParams.get('emailid');
}
if (msg == 'webinar') {
  document.querySelector('.textchange').innerHTML = "You'll shortly receive the presentation on your mail.";
} else {
  document.querySelector('.textchange').innerHTML = 'Your request has been received successfully. Our team will contact you soon.';
}
})();

/******/ })()
;
//# sourceMappingURL=success.bundle.js.map